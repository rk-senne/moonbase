...
func Catalog() []Tool {
	return []Tool{
		...
		{ID: "fd", Display: "fd", Description: "Simple, fast, user-friendly alternative to find.", Category: Cool,
			Brew: "fd", Apt: "fd-find", Dnf: "fd-find", Pacman: "fd",
			Manual: "Debian/Ubuntu install the binary as 'fdfind'."},
		{ID: "tree", Display: "tree", Description: "Recursive directory listing as an indented tree.", Category: Cool,
			Brew: "tree", Apt: "tree", Dnf: "tree", Pacman: "tree"},
		{ID: "tig", Display: "tig", Description: "Text-mode interface for git — browse history & diffs.", Category: Cool,
			Brew: "tig", Apt: "tig", Dnf: "tig", Pacman: "tig"},
		{ID: "direnv", Display: "direnv", Description: "Load/unload environment variables per directory.", Category: Cool,
			Brew: "direnv", Apt: "direnv", Dnf: "direnv", Pacman: "direnv"},
		{ID: "duf", Display: "duf", Description: "Better df — colorful, sortable disk-usage overview.", Category: Cool,
			Brew: "duf", Apt: "duf", Dnf: "duf", Pacman: "duf"},
		{ID: "yq", Display: "yq", Description: "Portable YAML/JSON/XML processor (jq for YAML).", Category: Cool,
			Brew: "yq", Pacman: "go-yq",
			Manual: "apt/dnf: grab the binary from https://github.com/mikefarah/yq/releases"},
		{ID: "just", Display: "just", Description: "Handy command runner — a modern, simpler make.", Category: Cool,
			Brew: "just", Dnf: "just", Pacman: "just",
			Manual: "apt: prebuilt binaries at https://github.com/casey/just#installation"},
		{ID: "hyperfine", Display: "hyperfine", Description: "Command-line benchmarking tool with statistics.", Category: Cool,
		...
		{ID: "dust", Display: "dust", Description: "Intuitive du — see what's eating your disk, fast.", Category: Cool,
			Brew: "dust", Pacman: "dust",
			Manual: "apt/dnf: grab the binary from https://github.com/bootandy/dust/releases"},
		{ID: "procs", Display: "procs", Description: "Modern ps replacement with color and search.", Category: Cool,
			Brew: "procs", Pacman: "procs",
			Manual: "apt/dnf: grab the binary from https://github.com/dalance/procs/releases"},
		{ID: "tldr", Display: "tealdeer", Description: "Fast, community-driven cheat sheets for CLI commands (tldr).", Category: Cool,
			Brew: "tealdeer", Pacman: "tealdeer",
			Manual: "apt/dnf: see https://github.com/tealdeer-rs/tealdeer#installing"},
		{ID: "glow", Display: "glow", Description: "Render Markdown beautifully in the terminal.", Category: Cool,
			Brew: "glow", Pacman: "glow",
			Manual: "apt/dnf: via Charm's repo — https://github.com/charmbracelet/glow#installation"},
		{ID: "yazi", Display: "yazi", Description: "Blazing-fast terminal file manager with previews.", Category: Cool,
			Brew: "yazi", Pacman: "yazi",
			Manual: "apt/dnf: see https://yazi-rs.github.io/docs/installation"},
		{ID: "zellij", Display: "zellij", Description: "Modern terminal workspace & multiplexer with layouts.", Category: Cool,
			Brew: "zellij", Pacman: "zellij",
			Manual: "apt/dnf: prebuilt binaries at https://github.com/zellij-org/zellij/releases"},
		{ID: "atuin", Display: "atuin", Description: "Magical shell history — searchable, synced, encrypted.", Category: Cool,
			Brew: "atuin", Pacman: "atuin",
			Manual: "apt/dnf: see https://docs.atuin.sh/guide/installation/"},
		{ID: "difft", Display: "difftastic", Description: "Structural diff that understands syntax (difft).", Category: Cool,
			Brew: "difftastic", Pacman: "difftastic",
			Manual: "apt/dnf: see https://difftastic.wilfred.me.uk/installation.html"},
		{ID: "k9s", Display: "k9s", Description: "Terminal UI to observe and manage Kubernetes clusters.", Category: Cool,
			Brew: "k9s", Pacman: "k9s",
			Manual: "apt/dnf: see https://k9scli.io/topics/install/"},

		// --- macOS-only gems ---
		{ID: "mas", Display: "mas", Description: "Install & update Mac App Store apps from the terminal.", Category: Cool,
			Brew: "mas", MacOnly: true},
		{ID: "trash", Display: "trash", Description: "Move files to the macOS Trash instead of a permanent rm.", Category: Cool,
			Brew: "trash", MacOnly: true},
		{ID: "terminal-notifier", Display: "terminal-notifier", Description: "Post native macOS notifications from the command line.", Category: Cool,
